...
ip addr add 10.0.1.110/24 dev vxlan2
...
ip link set vxlan1 up
ip addr add 10.0.0.121/24 dev vxlan1
...
ip link set vxlan1 up
ip addr add 10.0.1.120/24 dev vxlan1
route delete default
route add default gw 10.0.1.120 dev vxlan1
```
